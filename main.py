...
my_email = "muhammadmashoodkhan7@gmail.com"
my_email_password = "ncuu ewbq owmr qrjw"
...
class User(UserMixin, db.Model):
    ...
    #This will act like alist of BlogPost objects attached to each User.
...
# You can check for this header.html
...
def show_post(post_id):
    ...
    # Only allow logged-in users to comment on the posts
